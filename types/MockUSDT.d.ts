...
interface MockUSDTInterface extends ethers.utils.Interface {
  functions: {
...
export class MockUSDT extends BaseContract {
  ...
  callStatic: {
    ...
    faucet(to: string, overrides?: CallOverrides): Promise<void>;
